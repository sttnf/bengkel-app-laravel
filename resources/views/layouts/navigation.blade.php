            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->user_type === 'customer')
                        <!-- Customer Navigation -->
                        <x-nav-link :href="route('user.vehicles.index')" :active="request()->routeIs('user.vehicles*')">
                            {{ __('My Vehicles') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->user_type === 'customer')
                ...
                <x-responsive-nav-link :href="route('user.vehicles.index')" :active="request()->routeIs('user.vehicles*')">
                    {{ __('My Vehicles') }}
                </x-responsive-nav-link>
